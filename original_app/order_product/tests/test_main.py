...
import sys
# sys.path.append(os.path.abspath(r"D:\programing\個人用\original_app\order_product\tests"))
sys.path.append(os.path.abspath(r"D:\programing\個人用\original_app\order_product"))

# import original_app.order_product.main
    ...
    def test_main(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            with open(os.path.join(order_dir, order_file), 'w', encoding='utf-8') as f:
                f.write("""1,10,埼玉県,080-9999-9999,田中一郎,2016-12-25\n1,三十,埼玉県,080-9999-9999,田中一郎,2016-12-25""")
            ...
            with open(os.path.join(failure_dir, failure_file), encoding='utf-8') as f:
                c = f.read()
                self.assertEqual(c, '1,三十,埼玉県,080-9999-9999,田中一郎,2016-12-25,' + order_file + '\n',
            ...
            with open(os.path.join(delivery_dir, 'delivery_20161225.csv'), encoding='utf-8') as f:
                c = f.read()
                self.assertEqual(c, '1,10,埼玉県,080-9999-9999,田中一郎,2016-12-25,' + order_file + '\n',
                                 msg="main関数でテスト用注文受付ファイルを読み込ませたところ、"
